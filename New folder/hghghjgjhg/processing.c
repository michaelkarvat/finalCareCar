...
#define WEIGHT_THRESHOLD        80.0f    // Example threshold for weight (e.g., above 80 kg is abnormal)
#define TEMPERATURE_THRESHOLD   30.0f    // Example threshold for temperature (e.g., above 30 °C is abnormal)
#define CO2_THRESHOLD           600.0f   // Example threshold for CO₂ (e.g., above 600 ppm is abnormal)
